...
<%
	...
	guestList.add(new Guest(1,"KIM","2023/02","guard1@gmail.com","http://www.itwill1.com","타이틀1","컨텐트1"));
	guestList.add(new Guest(2,"GIM","2023/03","guard2@gmail.com","http://www.itwill2.com","타이틀2","컨텐트2"));
	guestList.add(new Guest(3,"LIM","2023/04","guard3@gmail.com","http://www.itwill3.com","타이틀3","컨텐트3"));
...
<ul>
	...
	<li><%=((List<Guest>)request.getAttribute("guestList")).get(1)%></li>
	<li><%=((List<Guest>)request.getAttribute("guestList")).get(2)%></li>
	<li>------------[4]Map---------------</li>
	...
	<li>${guestList[0].getGuest_date()}</li>
	<li>${guestList[0].getGuest_name()}</li>
	<li>${guestList[0].getGuest_email()}</li>
	<li>${guestList[0].getGuest_homepage()}</li>
